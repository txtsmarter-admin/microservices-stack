...
/**
 * ServiceSql service for the MyApp cloud backend.
...
// Define our service-sql service
@Service({
  name: serviceName,
...
export class ServiceSqlService extends moleculer.Service {
  // Our actions
  @Action()
  ...
  clearCache() {
    ...
    broker.broadcast('cache.clean.service-sql');
  }
}
